...
class Node {
  public:
    ...
    */
    ...
    MUSTACHE_API std::string to_template_string(const std::string& start, const std::string& stop) const;
    ...
    static MUSTACHE_API std::unique_ptr<Node> unserializeOwned(std::string_view serial);
    ...
    static MUSTACHE_API Node * unserialize(std::vector<uint8_t>& serial, size_t offset, size_t * vpos);

    /*! Legacy owning-pointer decoder. Prefer unserializeOwned(). */
    static MUSTACHE_API Node * unserialize(
        std::vector<uint8_t>& serial, size_t offset, size_t * vpos, const SerializationLimits& limits);

    /*! Legacy owning-pointer decoder. Prefer unserializeOwned(). */
    static MUSTACHE_API Node * unserialize(const uint8_t * serial, size_t length, size_t offset, size_t * vpos);
    ...
    /*! Legacy owning-pointer decoder. Prefer unserializeOwned(). */
    static MUSTACHE_API Node * unserialize(std::string_view serial, size_t offset, size_t * vpos);
